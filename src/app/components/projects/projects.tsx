...
export default function Projects() {
  ...
  return (
    <section id="projects">
      <span className="projects--header">Selected open source projects:</span>
      <div className="projects--columns">
        <div className="projects--column">
          {projectsElements.slice(0, projectsElements.length / 2)}
        </div>
        <div className="projects--column">
          {projectsElements.slice(projectsElements.length / 2)}
        </div>
      </div>
    </section>
  )
